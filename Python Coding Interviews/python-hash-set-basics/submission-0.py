...
def check_keys(hash_set: Set[str], keys: List[str]) -> List[bool]:
    ...
    # so we are given a list of keys and a hash set and we need to return a list of bools indicaiting if that key is in the hashset 

    # approach: 
    # - loop through list 
    # - check if key in hashset 
    # - append True or False to list 
    # retuirn list
