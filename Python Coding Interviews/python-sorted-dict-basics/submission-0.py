...
def get_values_before_target(sorted_dict, target):
    value_list = []
    ...
    # this short take a sorted dict and a target key and return a list of valuyes assiociated with keys that come before the target key in sorted order 
